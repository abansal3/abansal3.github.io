        ...
        <div class="container__item landing-page-container">
            <div class="content__wrapper">
                ...
                <div class="ellipses-container">
                    ...
                    <h2 class="bio">
                        I'm a technology enthusiast, designer and entrepreneur based out of Boston, currently working
                ...
                <div class="mobileOnly">
                    <h2 class="bio">
                        I'm a technology enthusiast, designer and entrepreneur based out of Boston, currently working on my software development company <a href="https://jinn.tech" target="_blank">Jinn</a>.
                    </h2>
                </div>
                            ...
                            <div class="col-md-8 col-md-offset-2 col-sm-12 text-center">
                                <div class="tabbed-content text-tabs">
                                    <ul class="tabs">
                                                                ...
                                                                <div class="tile-right bg-secondary">
                                                                    <div class="description">
                                                                        ...
                                                                        <div class="technologies">
                                                                            <span class="technology" ng-repeat="technology in portfolio.technologiesUsed">
                                                                                {{technology}}
                                                                            </span>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <li ng-controller="achievementController">
                                            <div class="tab-title">
                                            ...
                                            <div class="tab-content">
                                                <div class="container">
                                                    <div class="row">
                                                        <div class="col-md-8 col-sm-10 col-sm-offset-1 col-md-offset-2">
                                                            <div class="horizontal-tile" ng-repeat="achievement in achievements">
                                                                <div class="tile-left">
                                                                    <!--<a href="portfolio/{{portfolio.title.replace(' ','-').toLowerCase()}}">-->
                                                                        <div class="background-image-holder">
                                                                            <img alt="image" class="background-image" ng-src="{{achievement.image}}">
                                                                        </div>
                                                                    <!--</a>-->
                                                                </div>
                                                                <div class="tile-right bg-secondary">
                                                                    <div class="description">
                                                                        <h4 class="mb8">{{achievement.title}}</h4>
                                                                        <h6 class="uppercase">
                                        ...
                                        <!--<li>
                                            ...
                                            <div class="tab-content" ng-controller="blogController">
                    ...
                    <div class="container">
                        <div class="row contact">
                            <div class="half">
                                ...
                                <p>
                                    If you enjoyed getting to know me, drop me a message and I'd love to talk more. I appreciate your time and have a great day!
                                </p>
                                <hr>
                                <p>
                                    231 Forest Street
                        ...
                        <div class="row contactSocialIcons">
                            <a href="https://www.facebook.com/arpit.678" target="_blank"><i class="fa fa-facebook fa-3x" style="color: #92B1BE" alt="facebook"></i></a>
                            <a href="https://www.linkedin.com/in/arpit-bansal/" target="_blank"><i class="fa fa-linkedin fa-3x" style="color: #92B1BE" alt="linkedin"></i></a>
                            <a href="https://twitter.com/ArpitBansa1" target="_blank"><i class="fa fa-twitter fa-3x" style="color: #92B1BE" alt="twitter"></i></a>
                            <a href="https://www.instagram.com/arpitbansal3/" target="_blank"><i class="fa fa-instagram fa-3x" style="color: #92B1BE" alt="instagram"></i></a>
                            <a href="http://stackoverflow.com/users/5538541/arpit-bansal?tab=profile" target="_blank"><i class="fa fa-stack-overflow fa-3x" style="color: #92B1BE" alt="stack overflow"></i></a>
		                </div>
                    </div>
                </section>
		    </section>
